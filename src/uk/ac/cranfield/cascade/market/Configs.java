...
public class Configs {
	...
	//public int[] tradingWindowSizes = {2, 2,  2,3,2,  7,  4,0}; // 2*half hour = 1 hour; 7*1day = 1 week etc

	public int[] tradingWindow = {48};
	public int[] tradingWindowSizes = {0}; // 2*half hour = 1 hour; 7*1day = 1 week etc
