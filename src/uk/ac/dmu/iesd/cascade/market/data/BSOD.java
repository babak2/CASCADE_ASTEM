...
/**
 * The <em>BSOD</em> class encapsulates a data structure which 
 * defines buy-sell-offer-data used for trading
 * in the <em>PowerExchange</em> (Px) market.  
 * 
...
public class BSOD { //Buy-Sell-Offer-Data
	...
	public String getProductIDInHour() {
		String pIDinHour = "";
		if (productID == ASTEMConsts.PX_PRODUCT_ID_2H)
			pIDinHour = "2H";
		else if (productID == ASTEMConsts.PX_PRODUCT_ID_4H)
			pIDinHour = "4H";
		else if (productID == ASTEMConsts.PX_PRODUCT_ID_8H)
			pIDinHour = "8H";
