 ...
 * 1.3 - Modified the base class for ASTEM market integration, notably by adding 
 *       category and type (Babak)
 */
public abstract class AggregatorAgent implements ICognitiveAgent, IObservable {
	...
	public String getCategoryAsString() {
		 ...
		 String categoryInString;
			switch (this.category) {
	            case GEN_T: categoryInString = "T";
	                     break;
	            case GENDEM_E: categoryInString = "E";
	                     break;
	            case GENDEM_I: categoryInString = "I";
	                     break;
	            case DEM_S: categoryInString = "S";
	                     break;
	            default: categoryInString = "Invalid day";
	                   break;
			}
	...
	*/
	 ...
	 * TODO Temporary, to be eliminated later
	 */
	public AggregatorAgent(CascadeContext context) {
		this(context,BMU_CATEGORY.DEM_S, BMU_TYPE.DEM_SMALL);
	} 
