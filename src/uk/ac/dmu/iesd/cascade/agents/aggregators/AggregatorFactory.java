...
public class AggregatorFactory implements IAggregatorFactory{
	...
	/*public SupplierCo createSupplierCo(double[] baseProfile, double maxDem, double minDem){
		SupplierCo asCO = new SupplierCo(cascadeMainContext, messageBoard, baseProfile, BMU_CATEGORY.DEM_S, BMU_TYPE.DEM_LARGE, maxDem, minDem);
		return asCO;
	} */
	...
	public SupplierCo createSupplierCo(double[] baseProfile){
		...
		SupplierCo asCO = new SupplierCo(cascadeMainContext, messageBoard, BMU_CATEGORY.DEM_S, BMU_TYPE.DEM_SMALL, maxDem, minDem, baseProfile);
	...
	public BMPxTraderAggregator createGenericBMPxTraderAggregator(BMU_TYPE type, double[] baseLoadProfile){
		...
		case DEM_LARGE: 
			...
			bmuAgent = new GenericBMPxTraderAggregator(cascadeMainContext, messageBoard, BMU_CATEGORY.DEM_S, type,  maxDem, minDem, baseLoadProfile);
			break;
		case DEM_SMALL:
		...
		case GEN_COAL:
			...
			bmuAgent = new GenericBMPxTraderAggregator(cascadeMainContext, messageBoard, BMU_CATEGORY.GEN_T, type, maxGen, baseLoadProfile);
			break;				
		case GEN_CCGT:
